...
male_folder = '/home/runner/work/av-zoom/av-zoom/Pre_MVDR_Dataset/Male_clean';
female_folder = '/home/runner/work/av-zoom/av-zoom/Pre_MVDR_Dataset/Female';
music_folder = '/home/runner/work/av-zoom/av-zoom/Pre_MVDR_Dataset/Music';
noise_folder = '/home/runner/work/av-zoom/av-zoom/Pre_MVDR_Dataset/Noise';

% Create output folders for each mixture type
output_base = '/home/runner/work/av-zoom/av-zoom/Post_MVDR_Dataset/';
...
for i = 1:min(n_to_process, length(male_files))
    % select random male file index and check if it should be excluded
    max_attempts = 100;  % Prevent infinite loop
    attempt = 0;
    excluded_file = true;
    
    while excluded_file && attempt < max_attempts
        ...
        excluded_file = any(strcmp(exclude_names, male_base_name));
        
        if excluded_file
            fprintf('Skipping excluded file: %s\n', male_file.name);
        end
    ...
    if excluded_file
        fprintf('Warning: Could not find non-excluded file after %d attempts. Skipping iteration.\n', max_attempts);
        continue;
    end
